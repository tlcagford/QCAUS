...
if img_data is not None:
    ...
    # All other sections (Annotated Maps, Dark Photon, Blue-Halo, Magnetar QED, FDM profile, QCIS, EM Spectrum, Metrics, Formulas) are now displayed automatically after the Before/After.

    st.success("✅ All physics modules running — full display complete!")
