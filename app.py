...
# =============================================================================
# PROCESSING + ANNOTATED BEFORE/AFTER (exactly like your image)
# =============================================================================
if img_data is not None:
    ...
    # ANNOTATED BEFORE / AFTER (matches your screenshot style)
    ...
    if st.button("📦 Download All Results as ZIP"):
        ...
        with zipfile.ZipFile(zip_buffer, "w") as z:
            for name, arr, cmap in [
                ...
                ("ent_res", ent_res, "inferno"),
                ("dp_prob", dp_prob, "YlOrRd"),
