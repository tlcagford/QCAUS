...
if uploaded_file is not None or preset_data:
    ...
    # EM Spectrum Mapping with COLORS
    ...
    with col2:
        ...
        # Create colored layers using matplotlib colormaps
        infrared_colored = plt.cm.hot(img_gray)[:, :, :3]  # Red/orange colormap for IR
        visible_colored = plt.cm.viridis(img_gray)[:, :, :3]  # Green/blue colormap for visible
        xray_colored = plt.cm.plasma(img_gray)[:, :, :3]  # Purple/blue colormap for X-ray
